# U.S. Critical-Minerals Industrial Policy —  _Hamza Jabbar_

*Prepared April 2026 · References consolidated and verified from primary sources*
...
```mermaid
flowchart TD
    A[USGS critical minerals list\nand supply-risk framing] --> B[Section 232 investigations\nand trade leverage]
    A --> C[FAST-41 permitting acceleration\nand dashboard transparency]
    C --> D[Mine and processing\nproject development]
    D --> E[DoD DPA Title III\nawards]
    D --> F[DOE grants, ARPA-E,\nand loan support]
    D --> G[CHIPS-linked incentives\nfor semiconductor-relevant materials]
    E --> H[Midstream refining, separation,\nrecycling, by-product recovery]
    F --> H
    G --> H
    H --> I[Project Vault and other\nstockpiling or reserve mechanisms]
    H --> J[OEM offtake, strategic\nprocurement, and private investment]
    B --> J
    I --> J
```
...
```mermaid
timeline
    title U.S. critical-minerals policy timeline (2025–2026)
    2025-01 : DOE funds regional consortia for critical minerals and materials
    2025-01 : DoD Title III award to REEcycle — rare-earth recovery from e-waste
    ...
    2025-07 : DoD Title III tungsten award to Golden Metal Resources (Pilot Mountain, Nevada)
    2025-08 : DOE announces nearly $1 billion in intended funding for mining, processing, and manufacturing
    2025-08 : Office of Strategic Capital direct loan to MP Materials for heavy rare-earth separation
    ...
    2026-01 : White House Section 232 proclamation — directs negotiations on processed critical minerals
    2026-02 : EXIM Bank launches Project Vault
